...
class PhysiDiscretizer:
    """
    Load the data reader, split the data into 48 bins(hours)
    """

    def __init__(self, timestep=1.0, store_masks=True, impute_strategy='zero', start_time='zero',
                 config_path=os.path.join(os.path.dirname(__file__), 'physi_discretizer_config.json')):
    ...
    def transform(self, X, header=None, end=None):
        ...
        # set feature. categorical feature convert to one hot. numerical feature just one channel.
        cur_len = 0
        ...
        for i in range(N_channels):
            ...
            cur_len = end_pos[i]
        # 17 features convert to 59 dimensions. data shape (ts,59)
