...
from model import PhysiSelfAttention, PhysiRNN, PhysiLSTM, PhysiGRU, PhysiRCNN, PhysiAttRNN, PhysiTransformer
...
if __name__ == "__main__":
    ...
    ckpt_dir = f"exp_model_performance/ckpt/physi/{time}/"
